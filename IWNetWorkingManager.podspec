...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of IWNetWorkingManager.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/JinYang/IWNetWorkingManager'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'JinYang' => 'jianye0209@yeah.net' }
  s.source           = { :git => 'https://github.com/JinYang/IWNetWorkingManager.git', :tag => s.version.to_s }
